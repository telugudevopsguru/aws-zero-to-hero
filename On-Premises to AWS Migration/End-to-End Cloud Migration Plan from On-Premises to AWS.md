...
- Example use case: **Accessing internal application URLs (e.g., https://user-registration-dev.telugudevopsguru.com).**  
...
#### **Example URLs:**  
- **Jenkins** - https://jenkins.telugudevopsguru.com 
- **JFrog Artifactory** - https://artifactory.telugudevopsguru.com 
- **SonarQube** - https://sonarqube.telugudevopsguru.com
